namespace Dorian.RouteApi.Common.Constants
{
    public class ConfigurationKeys
    {
        public const string RouteGuardUsername = "RouteGuard:Username";
        public const string RouteGuardPassword = "RouteGuard:Password";
